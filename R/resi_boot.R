#' Robust Effect Size Index (RESI) point and interval estimation for models (XXX using boot package)
#'
...
#' @describeIn resi RESI point and interval estimation for models
#' @export
resi_boot.glm <- resi_boot.default

#' @describeIn resi RESI point and interval estimation for lm models
#' @export
resi_boot.lm <- function(model.full, model.reduced = NULL, data, anova = TRUE,
...
#' @export
resi_boot.nls <- function(model.full, model.reduced = NULL, data, coefficients = TRUE,
...
#' @export
resi_boot.survreg <- function(model.full, model.reduced = NULL, data, anova = TRUE,
                         coefficients = TRUE, nboot = 1000,
...
#' @export
resi_boot.coxph <- function(model.full, model.reduced = NULL, data, anova = TRUE,
                       coefficients = TRUE, nboot = 1000,
                       vcovfunc = vcov, alpha = 0.05, store.boot = FALSE,
                       Anova.args = list(), unbiased = TRUE, ...){
  if (missing(data)){
...
#' @export
resi_boot.hurdle <- function(model.full, model.reduced = NULL, data, coefficients = TRUE,
...
#' @export
resi_boot.zeroinfl <- resi.hurdle

#' @describeIn resi RESI point and interval estimation for GEE models
#' @export

resi_boot.geeglm <- function(model.full, data, anova = TRUE,
                        coefficients = TRUE, nboot = 1000,
...
#' @describeIn resi RESI point and interval estimation for GEE models
#' @export
resi_boot.gee <- function(model.full, data, nboot = 1000, alpha = 0.05,
...
#' @export
resi_boot.lme <- function(model.full, alpha = 0.05, nboot = 1000, vcovfunc = clubSandwich::vcovCR,
                     vcov.args = list(), ...){
...
#' @export
resi_boot.lmerMod <- function(model.full, alpha = 0.05, nboot = 1000,
